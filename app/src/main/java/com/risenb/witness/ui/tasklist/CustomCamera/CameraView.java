...
public class CameraView extends SurfaceView implements SurfaceHolder.Callback, ICameraOperation, IActivityLifiCycle {
    ...
    private void adjustView(Camera.Size adapterSize) {
        ...
        //让surfaceView的中心和FrameLayout的中心对齐
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) getLayoutParams();
        params.width = MyApplication.mScreenWidth;
        params.height = MyApplication.mScreenHeight;
        setLayoutParams(params);
    }
    ...
    private void initCamera() {
        ...
        //设置闪光灯
        turnLight(mCameraManager.getLightStatus());
     ...
     * 闪光灯开关  开->关->自动
     */
    private void turnLight(CameraManager.FlashLightStatus ligthStatus) {
