...
public class ListViewCommconAdapter extends BaseAdapter implements InterImage {
    ...
    //图片和视频
    public ListViewCommconAdapter(Context context, List<LastTaskBean.TaskListBean> mList, int index, List<String> strlist, String type) {
...
//      final   boolean isdelete=false;
        ...
        if ("0".equals(type)) {
            ...
            // viewHolderImage.mShowVideoView.setVisibility(View.VISIBLE);
        } else {
            viewHolderImage.mRecordVideo.setVisibility(View.GONE);
            viewHolderImage.mCameraPhoto.setVisibility(View.VISIBLE);
            //viewHolderImage.mShowVideoView.setVisibility(View.GONE);
        }
        ...
        viewHolderImage.mDeleteImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((EvidenceFirst) mContext).deleteShowCameraImage(String.valueOf(position1));
        ...
        if (null != list) {
            ...
            final MutilPartInfo info = list.get(position1);
            if ((null != info && info.getPosition() == position1)) {
                ...
                if ("0".equals(type)) {
                    ...
                    // viewHolderImage.mShowImage.setVisibility(View.GONE);
                    Bitmap dBitmap = BitmapFactory.decodeFile(info.getThumbnail());
//                    viewHolderImage.mShowVideoView.setMediaController(new MediaController(mContext));
//                    viewHolderImage.mShowVideoView.setVideoURI(Uri.parse(info.getVideourl()));
//                    viewHolderImage.mShowVideoView.start();
                    //viewHolderImage.mShowVideoView.requestFocus();
...
//        @BindView(R.id.taskevidence_show_videoview)
//        VideoView mShowVideoView;
