...
public class TaskIssueStateAdapter extends BaseAdapter implements InterImage {
    ...
    //图片和视频
    public TaskIssueStateAdapter(Context context, List<LastTaskBean.TaskListBean> mList, int index, List<String> strlist, String type) {
