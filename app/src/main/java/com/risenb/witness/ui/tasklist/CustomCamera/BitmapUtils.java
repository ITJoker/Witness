...
public class BitmapUtils {
    ...
    public boolean saveBitmap(Bitmap b, String absolutePath) {
        return saveBitmap(b, absolutePath, 100);
    }

    public boolean saveBitmap(Bitmap b, String absolutePath, Bitmap.CompressFormat format) {
        return saveBitmap(b, absolutePath, 100, format);
    }

    private boolean saveBitmap(Bitmap b, String absolutePath, int quality) {
        return saveBitmap(b, absolutePath, quality, Bitmap.CompressFormat.JPEG);
    }

    private boolean saveBitmap(Bitmap bitmap, String absolutePath, int quality, Bitmap.CompressFormat format) {
        try {
