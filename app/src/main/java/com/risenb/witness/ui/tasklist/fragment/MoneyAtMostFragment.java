...
public class MoneyAtMostFragment extends BaseLazyFragment {
    ...
    public static MoneyAtMostFragment newInstance(String mark) {
        MoneyAtMostFragment lf = new MoneyAtMostFragment();
