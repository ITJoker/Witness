...
public class ModelTwoExecIssuStateAdapter extends BaseAdapter implements InterImage {
    ...
    //图片和视频
    public ModelTwoExecIssuStateAdapter(Context context, List<LastTaskBean.TaskListBean> mList, int index, List<String> strlist, String type) {
