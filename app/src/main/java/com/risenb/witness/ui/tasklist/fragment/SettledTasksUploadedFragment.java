...
public class SettledTasksUploadedFragment extends Fragment {
    ...
    public static SettledTasksUploadedFragment newInstance(String mark) {
        SettledTasksUploadedFragment settledTasksUploadedFragment = new SettledTasksUploadedFragment();
        final Bundle args = new Bundle();
        args.putString("mark", mark);
        settledTasksUploadedFragment.setArguments(args);
        return settledTasksUploadedFragment;
    }
    ...
    public void initData() {
        String url = getResources().getString(R.string.service_host_address).concat(getString(R.string.settledTaskUploadList));
        ...
        MyOkHttp.get().post(mActivity, url, param, new GsonResponseHandler<BaseBeans<List<TaskListBean.TaskList>>>() {
            ...
            public void onSuccess(int statusCode, BaseBeans<List<TaskListBean.TaskList>> response) {
                ...
                if (null != data && data.size() > 0) {
                    ...
                    mComUpAdapter.setmOnItemClickListener(new CompletedUploadAdapter.OnRecyclerViewItemClickListener() {
                        @Override
