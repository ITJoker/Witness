 ...
 * 执行中上看状态
 */
public class ModelTwpExecTaskIssueState extends BaseUI {
...
//                mAdapter.notifyDataSetInvalidated();    //更新UI界面
        ...
        MyOkHttp.get().post(this, url, params, new GsonResponseHandler<BaseBeans<ExecTaskListInfo>>() {
            ...
            public void onSuccess(int statusCode, BaseBeans<ExecTaskListInfo> response) {
                ...
                if (null != info) {
                    ...
                    mAdapter = new ExecListViewCommconAdapter(ModelTwpExecTaskIssueState.this, info.getTaskList(), 2, info.getTaskList().get(0).getExampleFile(), info.getTaskList().get(0).getIsType());
    ...
    public void NextStep() {
        ...
        Intent intent = new Intent(ModelTwpExecTaskIssueState.this, ExecLastTaskSaveAndUpLoad.class);
