...
import com.risenb.witness.ui.tasklist.adapter.NonExeFragmentPagerAdapter;
 ...
 * 未执行fragment
 */
public class NonExecutionTaskFragment extends Fragment {
    protected Activity mActivity;

    public static final String NONEXECUTIONFRAGMENT = "NonExecution";
    public static final String NONEXECUTIONFRAGMENTTASKID = "NonExecutionTaskId";
    ...
    @BindView(R.id.non_exe_viewpager)
    ViewPager mNonExeViewPager;

    private NonExeFragmentPagerAdapter mNonExeAdapter;
    private List<Fragment> mFragmentList;

    private TextView[] tabs;
    private int currentIndex;
    private double type;
    private RecentlyDistanceFragment mRecentlyDistanceFragment;
    private MoneyAtMostFragment mMoneyAtMostFragment;
    private WillExpireFragment mWillExpireFragment;
    ...
    public void onResume() {
        super.onResume();
        if (mNonExeAdapter != null) {
            mNonExeAdapter.notifyDataSetChanged();
        }
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRecentlyDistanceFragment = RecentlyDistanceFragment.newInstance(NONEXECUTIONFRAGMENT);
        mMoneyAtMostFragment = MoneyAtMostFragment.newInstance(NONEXECUTIONFRAGMENT);
        mWillExpireFragment = WillExpireFragment.newInstance(NONEXECUTIONFRAGMENT);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nonexetaskfragment, container, false);
        unbinder = ButterKnife.bind(this, view);
        tabs = new TextView[3];
        tabs[0] = mRecentlyDistance;
        tabs[1] = mMoneyAtMost;
        tabs[2] = mWillExpire;
        mNonExeAdapter = new NonExeFragmentPagerAdapter(getChildFragmentManager(), mFragmentList);
        mNonExeViewPager.setAdapter(mNonExeAdapter);
        initListener();
        return view;
    }

    private void initListener() {
        mNonExeViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
    ...
    public void onTabClick(View v) {
        ...
        mNonExeViewPager.setCurrentItem(currentIndex, true);
    }
...
//        param.put("pagesize", "10");
    ...
    public void onDestroy() {
        super.onDestroy();
        unbinder.unbind();
        SharedPreferencesUtil.saveBoolean(getContext(), "NonExecution", false);
    }
}
