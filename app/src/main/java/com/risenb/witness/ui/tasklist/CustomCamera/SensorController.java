 ...
 * 加速度控制器  用来控制对焦
 */
public class SensorController implements IActivityLifiCycle, SensorEventListener {
    ...
    private SensorController() {
        mSensorManager = (SensorManager) MyApplication.getInstance().getSystemService(Activity.SENSOR_SERVICE);
