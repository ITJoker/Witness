...
public class ModelTwoEvidenceFirstAdapter extends BaseAdapter implements InterImage {
    ...
    //图片和视频
    public ModelTwoEvidenceFirstAdapter(Context context, List<LastTaskBean.TaskListBean> mList, int index, List<String> strlist, String type) {
        ...
        if (2 == whereindex) {
            ((ModelTwoEvidenceFirst) mContext).setListener(this);
        }
    }
...
//      final   boolean isdelete=false;
        ...
        viewHolderImage.mCameraPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (2 == whereindex) {
                    ((ModelTwoEvidenceFirst) mContext).TaskObtainEvidenceTakePhoto(EvidenceFirst.SYSTEM_TAKE_PHOTH_ONE, position1, mList.get(position).getSort());
                }
            }
        });
        ...
        viewHolderImage.mRecordVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (2 == whereindex) {
                    ((ModelTwoEvidenceFirst) mContext).CameraVideoRcord(position1, mList.get(position).getSort());
                }
