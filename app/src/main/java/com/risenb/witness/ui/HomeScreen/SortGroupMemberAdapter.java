...
public class SortGroupMemberAdapter extends BaseAdapter implements SectionIndexer {
	private List<HomeScreenCityBean> list = null;
	private Context mContext;

	public SortGroupMemberAdapter(Context mContext, List<HomeScreenCityBean> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<HomeScreenCityBean> list) {
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final HomeScreenCityBean mContent = list.get(position);
		if (view == null) {
