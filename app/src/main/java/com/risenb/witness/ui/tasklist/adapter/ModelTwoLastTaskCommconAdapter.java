...
public class ModelTwoLastTaskCommconAdapter extends BaseAdapter implements InterImage {
    ...
    //图片和视频
    public ModelTwoLastTaskCommconAdapter(Context context, List<LastTaskBean.TaskListBean> mList, int index) {

        this.mContext = context;
        this.mList = mList;
        mLayoutInflater = LayoutInflater.from(mContext);
        this.whereindex = index;
        ((ModelTwoLastTaskSaveAndUpLoad) mContext).setListener(this);
    ...
    private View ShowImageAndRecordVideo(final int position, View view, ViewGroup parent, String type) {
        ...
        viewHolderImage.mCameraPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((ModelTwoLastTaskSaveAndUpLoad) mContext).TaskObtainEvidenceTakePhoto(ModelTwoLastTaskSaveAndUpLoad.SYSTEM_TAKE_PHOTH_ONE_LAST, position1, mList.get(position).getSort());
                //}
            }
        });
