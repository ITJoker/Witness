...
public class CameraManager implements ICameraHelper {
    ...
    private FlashLightStatus mLightStatus;
    ...
    private CameraManager(Context context) {
        ...
        mLightStatus = FlashLightStatus.valueOf(SPConfigUtil.loadInt(SP_LIGHT_STATUE, FlashLightStatus.LIGHT_AUTO.ordinal())); //默认 自动
    ...
    public FlashLightStatus getLightStatus() {
        return mLightStatus;
    }

    public void setLightStatus(FlashLightStatus mLightStatus) {
