...
public class AnFQNumEditText extends RelativeLayout {
    ...
    private TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            EventBus.getDefault().post(new EventMessage.MesageEmpty(s.toString(), TextContentId));
            setTextContent(s.toString());
            // 恢复监听器
            Log.e("s.tostring", s.toString());
            MyApplication.getInstance().setAreaAnwer(s.toString());
            etContent.addTextChangedListener(mTextWatcher);
            setLeftCount();
        }
    ...
    public AnFQNumEditText setContentId(String strid) {
        this.TextContentId = strid;
        return this;
    }
    ...
    public void setTextContent(String str) {
        Log.e("setTextContent", TextContent);
