...
public class HomeScreenBrandsAdapter<T extends HomeScreenCompanyBean> extends BaseListAdapter<T> {
    ...
    public void BrandFlags(boolean flag) {
        this.flag = flag;
    ...
    private class ViewHolder extends BaseViewHolder<T> {
        ...
        protected void prepareData() {
            homescreengrid_tv.setText(bean.getCompanyname());
            homescreengrid_tv.setTextSize(MyApplication.getInstance().getResources().getDimension(R.dimen.dm006));
            if (position == itme) {
                if (flags == 0) {
