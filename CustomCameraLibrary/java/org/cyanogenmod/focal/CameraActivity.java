...
public class CameraActivity extends Activity implements CameraManager.CameraReadyListener, ShowcaseView.OnShowcaseEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSideBar = findViewById(R.id.sidebar_scroller);
        mWidgetRenderer = findViewById(R.id.widgets_container);
        mSavePinger = findViewById(R.id.save_pinger);
        ...
        // Setup HUDs
        mFocusHudRing = findViewById(R.id.hud_ring_focus);

        mExposureHudRing = findViewById(R.id.hud_ring_exposure);
        mExposureHudRing.setManagers(mCamManager);

        // Setup shutter button
        mShutterButton = findViewById(R.id.btn_shutter);
    ...
    public void startShowcaseWelcome() {
        if (SettingsStorage.getAppSetting(this, KEY_SHOWCASE_WELCOME, "0").equals("0")) {
            ...
            mShowcaseView = ShowcaseView.insertShowcaseView(mSideBar, this, getString(R.string.showcase_welcome_1_title), getString(R.string.showcase_welcome_1_body), co);
    ...
    public void startShowcasePanorama() {
        if (SettingsStorage.getAppSetting(this, KEY_SHOWCASE_PANORAMA, "0").equals("0")) {
            ...
            Point size = new Point();
            getWindowManager().getDefaultDisplay().getSize(size);
            mShowcaseView = ShowcaseView.insertShowcaseView(size.x / 2, size.y - Util.dpToPx(this, 16), this, getString(R.string.showcase_panorama_title),
